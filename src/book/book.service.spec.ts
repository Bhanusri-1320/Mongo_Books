...
describe('BookService', () => {
  ...
  beforeEach(async () => {
    const module = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: SchedulerRegistry, // Mock SchedulerRegistry since it is mentioned in the service
          useValue: {},
        },
      ],
    }).compile();
  ...
  describe('findAll', () => {
    it('calls bookModel.find and retuns an array of books', async () => {
      // model.find.mockResolvedValue('someValue'); // can write here or while defining the jest fn
